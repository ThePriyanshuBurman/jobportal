      ...
      >
        <Grid container direction="column" alignItems="center" spacing={3}>
          <Grid container item alignItems="center">
            <Grid item xs={3}>
            <Typography style={{ color: 'blue' }}>Application Status</Typography>
            </Grid>
            <Grid
              container
              item
          ...
          <Grid container item alignItems="center">
            <Grid item xs={3}>
              <Typography style={{ color: 'blue' }}>Sort By</Typography>
            </Grid>
            <Grid item container direction="row" xs={12} spacing={1}>
              ...
              >
                ...
                <Grid item>
                  <label for="name">
                    <Typography className={classes.customFont}>Name</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
              ...
              >
                ...
                <Grid item>
                  <label for="dateOfApplication">
                    <Typography className={classes.customFont}>Date of Application</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
              ...
              >
                ...
                <Grid item>
                  <label for="rating">
                    <Typography className={classes.customFontS}>Rating</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
